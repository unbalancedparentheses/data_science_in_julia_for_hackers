...
In summary, $α$ is just a smoothing parameter, so that probability of finding a word that is not in our dataset, doesn't go down to 0.

We still have to discuss what value should it be assigned.
