...
- Another person will be far, measuring the time it takes the stone to hit the ground as well as the distance $Δx$ the stoned travelled.

For the first iteration of the experiment, we will keep the initial angle θ~45°. We will loosen this constraint a bit later.
