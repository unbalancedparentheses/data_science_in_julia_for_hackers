...
If you start looking at the technology/innovation history you may gradually begin to notice a repeating pattern: There is a constant differentiation between the people who *do* and the people who *watch* and then narrate. "The History Written by the Losers" would [Nassim Nicholas Taleb](https://en.wikipedia.org/wiki/Nassim_Nicholas_Taleb) said, the people that are doing stuff don't have time for beauty writing. But the thing does not stop there. It is not only that the do-nothings who write about the findings of others, but also attribute it to them! And this comes from a worrying bias that has been developing throughout recent history: the linear thinking we are talking about. That –apparently– common sense in which knowledge is built from a purely intellectual work that can be done in the armchair at home, and that after acquiring this sacred theoretical knowledge it is possible to come up with technology or innovation.

So let´s think for a moment, does a child need to know the gear mechanisms of a bicycle, in order to be able to use it? does Messi need to know about fluid dynamics to make the ball take a curved trajectory? Did the Romans need to know the Navier-Stokes equation in order to build their huge aqueducts? Maybe you are thinking that these are very specific cases, but the reality is that those example share a general and universal property: The knowledge is acquired based on experimentation, implementation and heuristics, pure trial and error. And technological innovation follows the same mechanism, it was discovered by people that were  taking risks, taking action, with a pure trial-and-error experiential manner and, above all, without anyone truly understanding the theory behind.

In his book "Antifragile: Things That Gain from Disorder", Taleb problematizes this apparent "order" when it comes to generating innovation and lists a series of events/fields that were misrepresented by the "losers that write the history", generating the false illusion that theoretical discovery came before practice and the trial and error process. 

He is very clear when commenting that the development of the jet engine had nothing to do with the discoveries of physicists researching, but thanks to the cleverness and antifragile heuristics based on trial and error that engineers have developed, although in academic books it is said that the process was the opposite. Or in his main field, finances. It is unbelievable the way he describes how senior traders, that have been deploying several heuristics to make their trades, are much more complex than the ones generated by the pricing formulas that academics invented based on the trial-and-error experiences of people who are immersed in the market. And this happened because, in the process of trying to generalizate this heuristics into formal equations, the academics are constantly introducing fragilities. And the worst thing? After doing so, finance PhDs can't understand how traders can correctly assing prices to financial derivatives without knowing several theorems... So the wheel is broken.

We are makers. We are Hackers. And, as makers that we are, we learn by doing. That is another sign of how different technology is from the sciences. Scientists don't learn science by doing it, but by doing labs and problem sets. Scientists start out doing work that's perfect, in the sense that they're just trying to reproduce work someone else has already done for them. Eventually, they get to the point where they can do original work. Whereas makers, from the start, are doing original work; it's just very bad. So makers start original, and get good, and scientists start good, and get original.

So then, what role does Science play in all this and why is it useful for technology? As we already said, it is a tool that technology has to formalize all that chaotic based knowledge discovery. Formalization is very useful to teach and communicate some base knowledge and to build a solid foundation in order to keep expanding it. But it is also the way we found to draw out subjectivities regarding the understanding of our world.
...
And it is common to think that one does this by observation. We observe, observe, and observe, and we look for theories to best explain the mass of facts. But this idea began to annoy [Sir Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper) (1902-1994), the scientific philosopher, more and more. The problem, as Popper saw it, is that some bodies of knowledge more properly named pseudosciences would be considered scientific if the “Observe & Deduce” operating definition were left alone. 

What Popper brilliantly discovered is that what makes a theory truly scientific is not its ability to generate predictions or the number of corroborating cases it has, but its ability to be falsified. Moreover, in his own words "Every ‘good’ scientific theory is a prohibition: it forbids certain things to happen. The more a theory forbids, the better it is" and he said that because if the theory is forbidding something to happend, you can desing an experiment and try to make that happen. From true scientific theories is easy to make the following statement "If x happens, it would show demonstrably that theory y is not true". It’s the opposite of looking for verification; you must try to show the theory is incorrect, and if you fail to do so, thereby strengthen it.
