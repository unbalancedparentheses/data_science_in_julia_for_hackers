...
He is very clear when commenting that the development of the jet engine had nothing to do with the discoveries of physicists researching, but thanks to the cleverness and antifragile heuristics based on trial and error that engineers have developed, although in academic books it is said that the process was the opposite. 
Or in his main field, finances. It is unbelievable the way he describes how senior traders, that have been deploying several heuristics to make their trades, are much more complex than the ones generated by the pricing formulas that academics invented based on the trial-and-error experiences of people who are immersed in the market. 
And this happened because, in the process of trying to generalizate this heuristics into formal equations, the academics are constantly introducing fragilities. 
...
As a first approach, science is a method that was conceived to help humans discover the principles -invariant laws- that describe the world. 
...
We observe, observe, and observe, and we look for theories to best explain the mass of facts. But this idea began to annoy [Sir Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper) (1902-1994), the scientific philosopher, more and more. 
...
What Popper brilliantly discovered is that what makes a theory truly scientific is not its ability to generate predictions or the number of corroborating cases it has, but its ability to be falsified. 
...
In the rest of science, we have what are called "emergent laws" that arise from very complicated systems wherewhere the individual details don't matter, but the system as a whole behave in a very specific and recognizable way.
...
After all, what is a number? What does it look like? What comes to your mind when I speak about the number two? What do two cats and two roses have in common? Numbers appeared as a way to have a more efficient communication. 
