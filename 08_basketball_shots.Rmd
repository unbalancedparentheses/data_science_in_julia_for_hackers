...
We see that the model predicts almost constant probability as we vary the angle. This makes sense, considering that the angle doesn't seem too
relevant when shooting; the distance from the hoop is the relevant variable.
